...
<template>
  <div class="min-h-screen flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-900">
    <div class="w-full max-w-md">
      <div class="bg-white dark:bg-gray-800 rounded-3xl p-12 shadow-sm">
        ...
        <div class="text-center mb-8">
          <p v-if="!canResend" class="text-gray-500 dark:text-gray-400 text-sm">
