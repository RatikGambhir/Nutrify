...
<template>
  <div class="min-h-screen flex">
    <!-- Left Side - Gradient -->
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#e5989b] via-[#d47b7e] to-[#c25d60]">
      ...
      <div class="w-full max-w-md">
        ...
        <div class="mb-16">
          <NuxtLink to="/" class="flex items-center gap-2">
            <div class="w-8 h-8 bg-gray-900 dark:bg-white rounded"></div>
            <span class="text-xl font-bold text-gray-900 dark:text-white">efferd</span>
          </NuxtLink>
        </div>

        <!-- Back to Home -->
        <NuxtLink to="/" class="inline-flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white mb-12">
