...
// Use the settings composable for persistence
const { 
  ...
  <UDashboardPanel id="settings">
    ...
    <div class="p-6 max-w-5xl mx-auto">
      ...
      <div v-else-if="activeTab === 1" class="space-y-6">
        ...
        <UCard>
          <div class="space-y-6">
            <UFormGroup label="Theme" description="Choose your preferred color theme">
              <URadioGroup
            ...
            <UFormGroup label="Timezone" description="Your local timezone">
              <UInput
            ...
            <div class="space-y-4">
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  ...
                  <UToggle v-model="userSettings.workout.restTimerSound" />
                </div>
              </UFormGroup>
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  <div class="flex-1">
                    <label class="font-medium">Auto-start Rest Timer</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Automatically start rest timer after completing a set
                    </p>
                  </div>
                  <UToggle v-model="userSettings.workout.autoStartRest" />
                </div>
              </UFormGroup>
            </div>

            <div class="flex justify-end pt-4">
              <UButton color="primary" @click="saveWorkoutSettings">
          ...
          <div class="space-y-6">
            <div class="space-y-4">
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  ...
                  <UToggle v-model="userSettings.notifications.email" />
                </div>
              </UFormGroup>
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  ...
                  <UToggle v-model="userSettings.notifications.push" />
                </div>
              </UFormGroup>
            </div>
            ...
            <div class="space-y-4">
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  <div class="flex-1">
                    <label class="font-medium">Workout Reminders</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Get reminded about scheduled workouts
                    </p>
                  </div>
                  <UToggle v-model="userSettings.notifications.workoutReminders" />
                </div>
              </UFormGroup>
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  <div class="flex-1">
                    <label class="font-medium">Weekly Reports</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Receive weekly workout summary reports
                    </p>
                  </div>
                  <UToggle v-model="userSettings.notifications.weeklyReport" />
                </div>
              </UFormGroup>
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  <div class="flex-1">
                    <label class="font-medium">Achievement Alerts</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Get notified when you unlock achievements
                    </p>
                  </div>
                  <UToggle v-model="userSettings.notifications.achievementAlerts" />
                </div>
              </UFormGroup>
            </div>
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  <div class="flex-1">
                    <label class="font-medium">Show Workouts</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Allow others to see your workout history
                    </p>
                  </div>
                  <UToggle v-model="userSettings.privacy.showWorkouts" />
                </div>
              </UFormGroup>
              ...
              <UFormGroup>
                <div class="flex items-center justify-between">
                  <div class="flex-1">
                    <label class="font-medium">Show Statistics</label>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                      Allow others to see your workout statistics
                    </p>
                  </div>
                  <UToggle v-model="userSettings.privacy.showStats" />
                </div>
              </UFormGroup>
            </div>
            ...
            <div class="flex justify-end pt-4">
              <UButton color="primary" @click="savePrivacySettings">
