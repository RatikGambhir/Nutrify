...
//  TODO: I will break this up later, for now this will have to do
@Serializable
...
//
//@Serializable
//data class WorkoutRecommendation(val workout: String, val frequency: String, val benefit: String, val duration: String)
//
//@Serializable
//data class NutritionRecommendation(val calories: String, val carbs: String, val protein: String, val fat: String)
//@Serializable
//data class UserRecommendations(val recommendations: NutritionRecommendation, val workout: WorkoutRecommendation)
